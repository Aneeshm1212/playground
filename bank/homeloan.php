        ...
        <div class="row mt-5">
            <div class="col-md-6 m-auto">
              <div class="card card-body">
                ...
                <form action="savehome.php?type=2" method="POST"  enctype="multipart/form-data">
                <label for="name">Full Name</label>
                  ...
                  <div class="form-group">
                    <label >Address of Property to purchase</label>
                    <input
                      type="text"
                      id="addrr"
                      name="addrr"
                  ...
                  <div class="form-group">
                    <label >Full Price of Property</label>
                    <input
                      type="number"
                      id="fp"
                      name="fp"
                  ...
                  <div class="form-group">
                    <label >Identity Proof & Office ID:</label>
                    <input
                      type="file"
                      id="dt"
                      name="dt"
